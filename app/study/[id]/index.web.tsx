...
export default function StudyScreen() {
  ...
  const handleDeleteCard = async (cardId: string) => {
    ...
    // 🔥 THE FIX IS HERE 🔥
    // If the number of cards you've already reviewed (progress)
    // is now equal to the total cards left in the deck, you are completely done!
    if (progress >= remainingCards.length) {
      handleSessionFinish();
    }
